...
**Phase:** v0.2.x (ngay tiếp theo). Chi tiết: [`docs/decisions/0005-module-system.md`](docs/decisions/0005-module-system.md).
...
```
v0.2  ──────►  Struct, enum, generics                     [đang làm]
v0.2.x ─────►  Module system                              [next]
