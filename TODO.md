...
- Defer: generic V-overload (P1 chỉ String) · get-borrow-mutable (`&0 mutable`). **key-typed: BACKEND mở (ADR-0080 KM-P1a `c003a5f`); source-side KM-P1b đang code.**
