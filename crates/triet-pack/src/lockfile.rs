//! `dao.lock` — per-project lockfile mapping `pkg_name@version` →
...
//!
//! ```text
//! # dao.lock — auto-generated, do not edit by hand.
...
/// In-memory representation of a `dao.lock` file.
...
impl Lockfile {
    ...
    pub fn serialize(&self) -> String {
        ...
        out.push_str("# dao.lock — auto-generated, do not edit by hand.\n");
...
pub enum LockfileError {
    ...
    #[diagnostic(
        ...
        help("update the Triết toolchain — this `dao.lock` was generated by a newer build")
    )]
...
mod tests {
    ...
    fn save_then_load_round_trip() {
        let tmp = TempDir::new().unwrap();
        let path = tmp.path().join("dao.lock");
        let mut lf = Lockfile::empty();
