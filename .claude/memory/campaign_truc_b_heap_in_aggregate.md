...
### ⛔ NỢ Phase 3+ (chờ lệnh mới mở)
- **enum-field move-out** (`let e = h.msg`) — E2423, cần enum_slot cho dest + chưa use-case.
- **multi-level extraction** (`h.inner.x`, ≥2 projection) — E2423, `single_field`→None.
